...
async def process_pricelist_btn_click(
    ...
    try:
        price_info = ("<b>Наши тарифы:</b>\n\n"
                      ...
                      "Что это значит?\n\n"
                      "<b>Вы пополняете баланс через этого бота, расчёты происходит в эквиваленте Telegram Stars.\n\n"
                      "Оплата принимается в Telegram Stars и криптовалюте (GRAM - ex. Toncoin)\n\n"
                      ...
                      f"Каждый день происходит списание в {settings.payment.daily_price} Stars с Вашего личного кабинета.\n\n"
                      "Как только баланс становится ≤ 0, действие Ваших подписок приостанавливается (они НЕ удаляются!)\n\n"
                      "Как только баланс вновь становися положительным - оказание услуг возобновляется!"
        )
